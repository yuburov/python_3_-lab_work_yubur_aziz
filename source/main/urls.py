...
urlpatterns = [
    ...
    path('guest/<int:pk>/edit/', product_update_view, name='update_view'),
    path('guest/<int:pk>/delete', product_delete_view, name='delete_view'),
    path('guest/search/', search_product, name='search_product')
]
